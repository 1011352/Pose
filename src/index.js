...
const handButton = document.querySelector("#handPose")
const palmButton = document.querySelector("#handPalm")
...
handButton.addEventListener("click", () => captureFist())
palmButton.addEventListener("click", () => capturePalm())
